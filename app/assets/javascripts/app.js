define([
    ...
    function App() {
        ...
        _this.initialize = function(){
            ...
            var tabIcd = tabulatorModel.addTab(Multiglot.translations.tab_icd).render(function(){return new IcdCodePane().load()});
            ...
            var tabDrg = tabulatorModel.addTab(Multiglot.translations.tab_drg).render(function(){return new DrgCodePane().load()}).select();
